<template>
  <a-card class="dev-icons-page box-card cus-box-card" :bordered="false">
    <template #title>
    ...
    <div v-if="icons.length">
      ...
      <!-- <el-pagination
        ...
        :page-sizes="[48, 84, 168, 252, 336, 420]"
        :pager-count="5"
        small
        layout="total, sizes, prev,slot, pager, next, jumper"
        :total="state.length"
        @size-change="getIconList()"
...
const handleCopy = (icon: string, event: Event) => {
  const copyText = `<IconFont name="${icon}" />`
